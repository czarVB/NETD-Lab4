...
Public Class frmVehicleList
    ...
    Private Sub btnEnter_Click(sender As Object, e As EventArgs) Handles btnEnter.Click
        ...
        If IsValidInput() = True Then
            ...
            If currentCustomerIdentificationNumber.Trim.Length = 0 Then
                ...
                customer = New Customer(cmbMakes.Text, tbxModel.Text, tbxYear.Text, chkNew.Checked)
            ...
            Else
                ...
                customer.FirstName = tbxModel.Text
                customer.LastName = tbxYear.Text
            ...
            For Each customerEntry As DictionaryEntry In customerList
                ...
                lvwVehicles.Items.Add(customerItem)
    ...
    Private Function IsValidInput() As Boolean
        ...
        If tbxModel.Text.Trim.Length = 0 Then
        ...
        ' check if the first name has been entered
        If tbxYear.Text.Trim.Length = 0 Then
    ...
    Private Sub lvwCustomers_SelectedIndexChanged(sender As Object, e As EventArgs) Handles lvwVehicles.SelectedIndexChanged
        ...
        currentCustomerIdentificationNumber = lvwVehicles.Items(lvwVehicles.FocusedItem.Index).SubItems(identificationSubItemIndex).Text
        ...
        tbxModel.Text = customer.FirstName               ' get the first name and set the text box
        tbxYear.Text = customer.LastName                 ' get the last name and set the text box
